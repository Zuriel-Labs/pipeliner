...
- Stop dependent work only for an unanswered material question, pending required PM Testing/approval, missing access/compatible host or actual repository control. Finish other authorized work. Do not start another Issue after completion unless requested.
