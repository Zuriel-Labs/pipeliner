...
- Before asking, save resolved answers and finish any necessary evidence recording or task-owned cleanup. Send the question or approval request as the final ordinary message and end the turn immediately. After asking, stop all work and tool calls for this task, including independent or background continuation, polling, sleep loops, timers and reminders. Resume only after the Human replies, at their own pace; silence and elapsed time never supply answers or approval. Reuse saved answers and ask only remaining unresolved questions.
