...
- Use native question controls when available and permitted by the tool contract; otherwise use a clearly marked message. Required answers wait indefinitely. Silence cannot supply an answer or approval. No timers or scheduled reminders. Preserve answers and continue independent authorized work.
